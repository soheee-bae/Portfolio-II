export const projects = [
  {
    ...
    description:
      '영화의 자세한 정보를 제공하는 서비스, 회원가입과 로그인을 통해서 watchlist를 영화의 자세한 \n \n정보를 제공하는 서비스, 회원가입과 로그인을 통해서 watchlist를 사용해 유저들이 원하는 영화 리스트를 보관하고 저장할수 있는 서비스 영화의 자세한 정보를 제공하는 서비스, 회원가입과 로그인을 통해서 watchlist를 사용해 유저들이 원하는 영화 리스트를 보관하고 저장할수 있는 서비스 사용해 유저들이 원하는 영화 리스트를 보관하고 저장할수 있는 서비스 영화의 자세한 정보를 제공하는 서비스, 회원가입과 로그인을 통해서 watchlist를 사용해 유저들이 원하는 영화 리스트를 보관하고',
    github: 'https://github.com/soheee-bae/Gatsby-Image-Blog-Starter',
    demo: 'https://gatsbyimageblogstartermain.gatsbyjs.io/',
    skills: ['React', 'Javascript', 'CSS', 'HTML', 'Graphql', 'Gatsby']
  ...
  },
  {
    ...
    description:
      '사용자들이 하루동안 있었던 일들을 정리하며 느꼈었던 감정들을 글, 이모티콘과 사진을 통해 기록할 수 있는 서비스를 제공합니다. 사용자들은 감정에 이름을 주는 과정에서 막연했던 감정을 분명하게 할수 있으며 그 감정의 원인을 찾아보고 미래에는 좀 더 유연하게 대처할수 있는 능력과 메타인지 능력을 기를 수가 있습니다.',
